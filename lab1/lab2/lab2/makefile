...
sim: all_knobs.o knob.o cache.o sim_main.o memory.o sim.h sim.cpp
	${CC} ${COMPILE_OPTION} -o sim sim.cpp all_knobs.o knob.o cache.o sim_main.o memory.o ${LINK_OPTION}
